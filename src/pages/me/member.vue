<template>
  <view class="member">
    ...
    <!-- #endif -->
    <Interactive ref="interactive" @check-exit-popup="checkExitPopup" @close-unpaid-remind-popup="closeUnpaidRemindPopup" @payment-cancel="payStayTime" @payment-fail="payStayTime" @check-short-exit="checkShortExit" />
    <Vip />
  </view>
</template>

<script>
import Interactive from '../../uni_modules/hfs-fe-uni-module/memberPages/member/components/interactive.vue'
import Vip from '../../uni_modules/hfs-fe-uni-module/memberPages/member/components/vip.vue'
import { getAccountInfo } from '../../utils/login'
import { isHFSParent, nativeBridge } from '@/uni_modules/hfs-fe-uni-plugins'

export default {
  components: { Interactive, Vip },
  data() {
    return {
      options: {},
      degradeInfo: {},
