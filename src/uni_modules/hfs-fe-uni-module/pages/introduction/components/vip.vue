<template>
  <view class="vip">
    <view class="vip-bg">
      <image class="vip-bg__tag" :src="`${resourceUrl}vip_tag.png`" />
    </view>
...
.vip {
  position: relative;
  background: linear-gradient(180deg, #ebf8bf, #ffffff 30%);
  border: 2rpx solid #ffffff;
  border-radius: 40rpx;
  margin: 12rpx 20rpx 12rpx 22rpx;
  overflow: hidden;
  &-bg {
    position: absolute;
    left: 50%;
